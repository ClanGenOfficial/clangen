...
#For the "Custom Font" setting
def change_font(filename,font):
    cwd = os.getcwd()
    file_path = os.path.join(cwd, "resources", filename)
...
while True:
    ...
    if game.settings['custom font']:
        #all json files changed
        change_font("text_boxes_dark.json","clangen")
        change_font("text_boxes.json","clangen")
        #change_font("buttons_small.json","clangen")
        change_font("buttons.json","clangen")
        change_font("credits_text.json","clangen")
        change_font("defaults_small.json","clangen")
        change_font("defaults.json","clangen")
        change_font("tool_tips.json","clangen")
        change_font("tool_tips_small.json","clangen")
        change_font("text_boxes_small.json","clangen")
        change_font("text_boxes_dark_small.json","clangen")

    else:
        change_font("text_boxes_dark.json","notosans")
        change_font("text_boxes.json","notosans")
        #change_font("buttons_small.json","notosans")
        change_font("buttons.json","notosans")
        change_font("credits_text.json","notosans")
        change_font("defaults_small.json","notosans")
        change_font("defaults.json","notosans")
        change_font("tool_tips.json","notosans")
        change_font("tool_tips_small.json","notosans")
        change_font("text_boxes_small.json","notosans")
        change_font("text_boxes_dark_small.json","notosans")

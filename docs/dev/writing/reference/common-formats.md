...
| `low_lawful`   | Use in conjunction with other tags to constrain the affected cats. **It cannot be used alone.** All tagged cats with a 0-8 lawfulness facet in prior tagged group (eg. Clan, patrol) are affected. MUST BE LISTED AFTER NON-FACET TAGS.       |

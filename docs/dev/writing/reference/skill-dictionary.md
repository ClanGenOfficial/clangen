...
Cats with the ```CLEVER``` skill are creative and intelligent and use their mind to come up with innovative and sophisticated solutions to challenges they encounter. This skill is applicable in patrols and events that require a sophisticated set of events, solution to a problem, or are about outsmarting predator, prey, and other cats.

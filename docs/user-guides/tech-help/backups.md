...
4. Rename the folder (ex: 0.13 backup)
...
Unsure how to compress files/folders on your Operating system?
...
**When Compressing for ClanGen** it is recommended to *rename* the zipped folder so the main folder is not confused for the actual contents. For example, this is helpful when transferring saves for ClanGen, as it avoids creating a second "saves" folder that would prevent the game from finding your actual saves.

...
class Name():
    ...
    normal_suffixes = [  # common suffixes
        ...
        "tail", "tree", "throat", "tuft", "watcher", "water", "weed", "whisper", "willow", "wind", "wing", "wish"
    ]
    ...
    loner_names = [
        ...
        "Tumble", "Voltage", "Vinnie", "Venture", "Vida", "Guinness",
        "Polly", "Piper", "Pepper", "Lakota", "Dakota", "Bently", "Chinook",
        "Tiny", "Ula", "Union", "Uriel", "Orion", "Oakley", "Roselie", "Mollie",
        ...
        "Toast", "Flabby", "Crunchy", "Sorbet", "Murder", "Mittens", "Molly",
        "Vanilla", "Mint", "Nikki", "Pocket", "Tabatha", "Gravy", "Dr. Pepper",
        "Potato", "Chewy", "Pumpernickel", "Pecan", "Old Man Sam", "Icecube",
        "Pearl", "Jasper", "Stan", "Rose", "Mojo", "Kate", "Pepsi", "Coke",
        ...
        "Shimmer", "Mimi", "Melody", "Leon", "Punk", "Mew", "Fern", "Elwood",
        ...
        "Hot Sauce", "Habanero", "Taco Bell", "Cheetoman", "Queso", "Ruby", "Zoe",
        "Molly Murder Mittens", "Peanut Wigglebutt", "Cheeto", "Taco", "Max",
        "Sparky", "Cosmo", "Sam", "Judge Judy", "Fred", "Leo", "Tucker", "Minette",
        "Milo", "Fork", "Penny", "Zelda", "Jake", "Felix", "Oliver", "Bella",
        "Kitty", "Chloe", "Angel", "Samantha", "Muschi", "Chicco", "Caramel",
        "Charlotte", "Chanel", "Lola", "Ollie", "Boo", "Frankie", "Hotdog"
    ]

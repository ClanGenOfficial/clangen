...
class Cat():
    ...
    def __init__(self,
        ...
        if status is None and moons is None:
            ...
            if status == 'newborn':
                ...
                self.age = 'senior'
            elif status in ['apprentice', 'mediator apprentice', 'medicine cat apprentice', "caretaker apprentice"]:
                self.age = 'adolescent'
            else:
    ...
    def status_change(self, new_status, resort=False):
        ...
        elif self.status == 'caretaker':
            pass

        elif self.status == 'caretaker apprentice':
            pass
    ...
    def rank_change_traits_skill(self, mentor):
        ...
        if self.status in ["warrior", "medicine cat", "mediator", "caretaker"]:
    ...
    def one_moon(self):
        ...
        if self.status in ['apprentice', 'mediator apprentice', 'medicine cat apprentice', "caretaker apprentice"]:
            self.update_mentor()
    ...
    def retire_cat(self):
        ...
        if self.moons > 6 and self.status in ["apprentice", "medicine cat apprentice", "mediator apprentice", "caretaker apprentice"]:
    ...
    def is_valid_mentor(self, potential_mentor: Cat):
        ...
        if self.status == 'mediator apprentice' and potential_mentor.status != 'mediator':
            return False
        if self.status == 'caretaker apprentice' and potential_mentor.status != 'caretaker':
            return False

...
class Name():
    ...
    normal_prefixes = [
        ...
        'Flight', 'Flint', 'Flip', 'Flood', 'Flower', 'Flutter', 'Fluttering', 'Fly', 'Fog', 'Forest', 'Freckle', 'Fringe',
        ...
        'Mallow', 'Mantis', 'Maple', 'Marigold', 'Marsh', 'Marten', 'Meadow', 'Melting', 'Midge', 
        ...
        'Ridge', 'Rift', 'Ripple', 'Rising', 'River', 'Roach', 'Rook', 'Root', 'Rose', 'Rosy', 'Rowan', 'Rubble',
        'Running', 'Rush', 'Rye', 'Sage', 'Scorch', 'Sedge', 'Seed', 'Shard', 'Sharp', 'Shattered', 'Sheep', 
        ...
        'Dragon', 'Wyvern', 'Earth', 'Eternal', 'Time', 'Ghost', 'God', 'Magic', 'Mind', 'Mountain', 'Royal', 'Shade', 'Spirit', 'Soul'
    ]

    colour_prefixes = {
        'WHITE': [
            'White', 'White', 'Pale', 'Snow', 'Cloud', 'Cloudy', 'Milk', 'Hail', 'Frost', 'Frozen', 'Freeze', 'Ice', 'Icy', 'Sheep',
            'Blizzard', 'Flurry', 'Moon', 'Light', 'Bone', 'Bright', 'Swan', 'Dove', 'Wooly', 'Cotton', 'Warm', 'Arctic'
        ],
        'PALEGREY': [
    ...
    loner_names = [
        "Abyss", "Ace", "Adam", "Admiral", "Ah", "Agatha", "Alcina", "Alec", "Alfie", "Alice", "Amber", "Amelia",
        "Amity", "Amy", "Angel", "Anita", "Anubis", "Armin", "Apple Cider", "April", "Apu", "Ash", "Aurora", "Azula",
        "Aries", "Aquarius", "Baba Yaga", "Bagel", "Bailey", "Baisel", "Bandit", "Baphomet", "Bastet", "Bean",
        "Beanie Baby", "Beanie", "Beans", "Bebe", "Bede", "Belle", "Ben", "Benny", "Bently", "Bentley", "Beverly",
        "Bibelot", "Big Man", "Bigwig", "Birb", "Birdie", "Blinky Stubbins", "Blu",  "Bluebell", "Bologna", "Bolt",
        "Bonbon", "Bongo", "Bonnie", "Bonny", "Boo", "Booker", "Brandywine", "Bren", "Broccoli", "Buddy", "Bullwinkle",
        "Bumblebee", "Bunny", "Burger", "Burm", "Bub", "Cake", "Callie", "Calvin", "Cancer", "Cannelloni", "Capricorn",
        "Caramel", "Cardamom", "Carmen", "Carmin", "Carolina", "Caroline", "Carrie", "Catie", "Catty", "Catrick",
        "Cayenne", "Cece", "Chance", "Chanel", "Chansey", "Chaos", "Charles", "Charlie", "Charlotte", "Charm",
        "Chase", "Chip", "Cheese", "Cheesecake", "Cheeto", "Cheetoman", "Chef", "Cherry", "Chester", "Chewie", "Chewy",
        ...
        "Coral", "Cosmo", "Cowbell", "Cowboy", "Crab", "Cracker", "Cream", "Crispy", "Crow", "Crunchwrap", "Crunchy",
        "Cupcake", "Cutie", "Cooper", "Confetti", "Cyprus", "Dakota", "Dan", "Dandelion", "Daliah", "Dave", "Deli",
        "Delilah", "Della", "Dewey", "Digiorno", "Dirk", "Diona", "Dizzy", "Dolly", "Donald", "Donuts", "Dorian",
        "Dorothy", "Double Trouble", "Dova", "Dragonfly", "Dreamy", "Duchess", "Dune", "Dunnock", "Dust Bunny",
        "Eclipse", "Daisy Mae", "Eda", "Eddie", "Eevee", "Egg", "Elton", "Ember", "Emerald", "Emeline", "Emi", "Emma",
        "Emy", "Erica", "Esme", "Espresso", "Eve", "Evelyn", "Evie", "Evilface", "Erebus", "Fallow", "Fang", "Fawn",
        "Feather", "Felix", "Fern", "Ferret", "Ferry", "Figaro", "Finch", "Firefly", "Fishleg", "Fishtail", "Fiver",
        ...
        "Grasshopper", "Gravy", "Guinness", "Gust", "Gwendoline", "Gwynn", "Gemini", "Habanero", "Haku", "Harvey",
        "Havoc", "Hawkbit", "Hawkeye", "Hazel", "Herc", "Hercules", "Hiccup", "Highness", "Hlao", "Holly", "Hop",
        "Hot Sauce", "Hotdog", "Hughie", "Human", "Hunter", "Harlequin", "Ice", "Icecube", "Ice Cube", "Icee", "Igor",
        "Ike", "Indi", "Insect", "Ipsy", "Isabel", "Jack", "Jade", "Jaiden", "Jake", "James", "Jasper", "Jaxon", "Jay",
        "Jelly Jam", "Jenny", "Jesse", "Jessica", "Jester", "Jethro", "Jewel", "Jewels", "Jimmy", "Jiminy Cricket",
        ...
        "Lily", "Linden", "Little Lady", "Little Nicky", "Loaf", "Lobster", "Lola", "Lollipop", "Loona", "Lora",
        "Lorado", "Louie", "Louis", "Luchasaurus", "Lucky", "Lucy", "Luci-Purr", "Lugnut", "Luigi", "Luna", "Lupo",
        "Loyalty", "Libra", "Madi", "Maddy", "Makwa", "Maleficent", "Maggie", "Manda", "Mange", "Mango", "Marathon",
        "Marceline", "Marny", "Matcha", "Matador", "Maverick", "Max", "May", "McChicken", "McFlurry", "Mick", "Meatlug",
        "Medusa", "Melody", "Meow-Meow", "Meowyman", "Mera", "Mew", "Midnight Goddess", "Miles", "Milhouse", "Millie",
        "Milo", "Milque", "Mimi", "Minette", "Mini", "Minna", "Minnie", "Mint", "Minty", "Missile Launcher", "Misty",
        "Mitski", "Mittens", "Mocha", "Mocha", "Mojo", "Mollie", "Molly", "Molly Murder Mittens", "Monika", "Monster",
        "Monte", "Monzi", "Moon", "Mop", "Moxie", "Mr. Kitty", "Mr. Kitty Whiskers", "Mr. Whiskers", "Mr. Wigglebottom",
        "Mucha", "Murder", "Mushroom", "Mitaine", "Myko", "Neel", "Nagi", "Nakeena", "Neil", "Nemo", "Nessie", "Nick",
        "Nightmare", "Nikki", "Niles", "Ninja", "Nintendo", "Nisha", "Nitro", "Noodle", "Nottingham", "Norman" "Nova",
        "Nugget", "Nuggets", "Nuka", "Nutella", "O'Leary", "Oakley", "Oapie", "Obi Wan", "Odetta", "Old Man Sam",
        "Oleander", "Olga", "Oliver", "Oliva", "Ollie", "Omelet", "Onyx", "Oops", "Oopsy Dazey", "Ophelia", "Oreo",
        "Orion", "Oscar", "Otto", "Owen", "Pangur", "Paulina", "Peach", "Peanut", "Peanut Wigglebutt", "Pear", "Pearl",
        "Pecan", "Penny", "Peony", "Pepper", "Pichi", "Pickles", "Pierre", "Pikachu", "Ping", "Ping Pong", "Pip",
        "Piper", "Pipsqueak", "Pipkin", "Pocket", "Pochito", "Poki", "Polly", "Pong", "Ponyboy", "Poopy", "Porsche",
        "Potato", "President", "Prickle", "Princess", "Private Eye", "Pudding", "Pumpernickel", "Punk", "Purdy",
        ...
        "Rolo", "Roman", "Roomba", "Rooster", "Rory", "Rose", "Roselie", "Ruby", "Rudolph", "Rue", "Ruffnut", "Rum",
        "Sadie", "Sailor", "Saki", "Salmon", "Salt", "Sam", "Samantha", "Sandwich", "Sandy", "Sausage", "Schmidt",
        "Scotch", "Scrooge", "Seamus", "Sekhmet", "Sega", "Seri", "Shamash", "Shampoo", "Shamwow", "Shay", "Sherman",
        "Shimmer", "Shiver", "Silva", "Silver", "Slinky", "Skrunkly", "Sloane", "Slug", "Slushie", "Smarty Pants",
        ...
        "Sweet Marmalade", "Sweet Leon", "Sweet Creature", "Sweetie", "Scorpio", "Sagittarius", "Tabatha", "Tabby",
        "Tabbytha", "Taco", "Taco Bell", "Tasha", "Tamagotchi", "Tay", "Teacup", "Teddie", "Tempest", "Tetris",
        "Tesora", "Teufel", "The Captain", "Theo", "Thumbelina", "Tiana", "Tiny", "Tin Man", "Tikka", "Timmy", "Toast",
        ...
        "Tumble", "Turbo", "Twilight", "Twinkle Lights", "Twister", "Twix", "Toastee", "Taurus", "Ula", "Ulyssa",
        "Union", "Uriel", "Vanilla", "Van Pelt", "Vaxx", "Venture", "Via", "Vida", "Viktor", "Vinnie", "Vinyl",
        "Violet", "Vivienne", "Void", "Voltage", "Vox", "Virgo", "Wanda", "Warren Peace", "Webby", "Wendy", "Whiskers",
        "Whisper", "Wigglebutt", "Wiggity Wacks", "Windy", "Wishbone", "Wisp", "Wisteria", "Whiz Kid", "Worm", "X'ek",
        "Xelle", "Yaoyao", "Yen", "Yeza", "Zelda", "Zim", "Zoe", "Zorro",

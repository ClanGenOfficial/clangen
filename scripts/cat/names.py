...
class Name():
    ...
    normal_suffixes = [  # common suffixes
        ...
        "muzzle", "needle", "nettle", "night", "noise", "nose", "nut", "pad", "patch", "path", "paws", "peak", "petal", "pond",
    ...
    normal_prefixes = [
        ...
        'Badger', 'Barley', 'Basil', 'Bass', 'Bay', 'Bayou', 'Beam', 'Bear', 'Beaver', 'Bee', 'Beech', 'Beetle', 'Bella', 'Berry',
        'Big', 'Billy', 'Birch', 'Bird', 'Bite', 'Bitter', 'Bittern', 'Bleak', 'Blight', 'Blink', 'Bliss', 'Blizzard', 'Bloom',
        ...
        'Gorge', 'Gorse', 'Grass', 'Gravel', 'Grouse', 'Gull', 'Gust', 'Hail', 'Half', 'Hare', 'Harry', 'Harvest', 'Harvey', 
        ...
        'Pear', 'Peat', 'Peat', 'Perch', 'Petal', 'Pheasant', 'Pigeon', 'Pike', 'Pine', 'Pink', 'Piper', 'Plover', 'Plum', 'Pod',
        ...
        'Ridge', 'Rift', 'Riley', 'Ripple', 'Rising', 'River', 'Roach', 'Rook', 'Root', 'Rose', 'Rosy', 'Rot', 'Rowan', 'Rubble',
        ...
        'Tumble', 'Turtle', 'Twisted', 'Vine', 'Vixen', 'Warm', 'Wasp', 'Wave', 'Weasel', 'Web', 'Wet', 'Wheat', 'Whirl', 'Whisker',
    ...
    loner_names = [
        ...
        "Aurora", "Azula", "Bagel", "Bailey", "Bandit", "Baphomet", "Bastet", "Bean", "Beans", "Bede", "Belle", "Benny", "Bently", 
        "Bentley", "Beverly", "Big Man", "Birb", "Blu",  "Bluebell", "Bologna", "Bolt", "Bonbon", "Bongo", "Bonnie", "Bonny", "Boo",
        "Broccoli", "Buddy", "Bumblebee", "Bunny", "Burger", "Burm", "Cake", "Callie", "Calvin", "Caramel", "Carmen", "Carmin", 
        "Carolina", "Caroline", "Carrie", "Catie", "Catty", "Chance", "Chanel", "Chansey", "Chaos", "Charles", "Charlie", "Charlotte",
        "Charm", "Chase", "Cheese", "Cheesecake", "Cheeto", "Cheetoman", "Chef", "Cherry", "Chester", "Chewie", "Chewy", "Chicco", 
        "Chief", "Chinook", "Chip", "Chloe", "Chocolate", "Chocolate Chip", "Chris", "Chrissy", "Cinder", "Cinderblock", "Cloe", "Cloud",
        "Cocoa", "Cocoa Puff", "Coffee", "Conan", "Cookie", "Coral", "Cosmo", "Cowbell", "Cowboy", "Crab", "Cracker", "Cream", "Crispy",
        "Crow", "Crunchwrap", "Crunchy", "Cupcake", "Dakota", "Dan", "Dave", "Deli", "Delilah", "Della", "Dewey", "Dirk", "Dolly", "Donald", 
        "Dragonfly", "Dreamy", "Duchess", "Dune", "Dunnock" "Eclipse",  "Eda", "Eddie", "Eevee", "Egg", "Ember", "Emerald", "Emi", 
        "Emma", "Emy", "Erica", "Espresso", "Eve", "Evelyn", "Evie", "Evilface", "Fallow", "Fang", "Fawn", "Feather", "Felix", "Fern",
        "Ferret", "Ferry", "Finch", "Firefly", "Fishleg", "Fishtail", "Fiver", "Flabby", "Flower", "Fluffy", "Flutie", "Fork", "Frank",
        "Frankie", "Frannie", "Fred", "Freddy", "Free", "French", "French Fry", "Frito", "Fry", "Frye", "Gamble", "Gargoyle", "Garnet",
        "Geode", "George", "Ghost", "Gibby", "Gir", "Gizmo", "Glass", "Glory", "Goose", "Grace", "Grain", "Grasshopper", "Gravy",  
        "Guinness", "Gust", "Gwendoline", "Gwynn", "Habanero", "Haku", "Harvey", "Havoc", "Herc", "Hercules", "Hiccup", "Holly", "Hop",  
        "Hot Sauce", "Hotdog", "Hughie", "Human", "Hunter", "Ice", "Icecube", "Ice Cube", "Icee", "Igor", "Ike", "Indi", "Insect", 
        "Isabel", "Jack", "Jade", "Jaiden", "Jake", "James", "Jasper", "Jaxon", "Jay", "Jenny", "Jesse", "Jessica", "Jester", "Jethro",
        "Jewel","Jewels", "Jimmy", "Jinx", "John", "Johnny", "Joker", "Jolly", "Jolly Rancher", "Joob", "Jubie", "Judas", "Jude", "Judy",
        "Juliet", "June", "Jupiter", "KD", "Kate", "Katy", "Kelloggs", "Ken", "Kendra", "Kenny", "Kermit", "Kerry", "Ketchup", "King",
        "Kingston", "Kip", "Kisha", "Kitty", "Kitty Cat", "Klondike", "Knox", "Kodiak", "Kong", "L", "Lacy", "Lakota", "Laku", "Lee", 
        "Leo", "Leon", "Lester", "Lex", "Lilith", "Lily", "Lily", "Loaf", "Lobster", "Lola", "Loona", "Lora", "Louie", "Louis", "Lucky",
        "Lucy", "Lugnut", "Luigi", "Luna", "Lupo", "Madi", "Makwa", "Maleficent", "Manda", "Mange", "Mango", "Marceline", "Matcha", 
        "Maverick", "Max", "May", "McChicken", "Meatlug", "Melody", "Meow-Meow", "Meowyman", "Mera", "Mew", "Miles", "Millie", "Milo",
        "Milque", "Mimi", "Minette", "Mini", "Minna", "Minnie", "Mint", "Minty", "Missile Launcher", "Mitski", "Mittens", "Mocha", 
        "Mocha", "Mojo", "Mollie", "Molly", "Molly Murder Mittens", "Monika", "Monster", "Monte", "Monzi", "Moon", "Mop", "Moxie", 
        "Mr. Kitty", "Mr. Kitty Whiskers", "Mr. Whiskers", "Mr. Wigglebottom", "Mucha", "Murder", "Muschi", "Nagi", "Nakeena", "Neil",
        "Nemo", "Nessie", "Nick", "Nightmare", "Nikki", "Niles", "Ninja", "Nintendo", "Nisha", "Nitro", "Noodle", "Norman" "Nova", 
        "Nugget", "Nuggets", "Nuka", "Nutella", "O'Leary", "Oakley", "Oapie", "Obi Wan", "Old Man Sam", "Oleander", "Olga", "Oliver", 
        "Oliva", "Ollie", "Omelet", "Onyx", "Oops", "Ophelia", "Oreo", "Orion", "Oscar", "Owen", "Peach", "Peanut", "Peanut Wigglebottom",
        "Peanut Wigglebutt", "Pear", "Pearl", "Pecan", "Penny", "Peony", "Pepper", "Pichi", "Pickles", "Pikachu", "Ping", "Ping Pong",
        "Pip", "Piper", "Pipsqueak", "Pocket", "Poki", "Polly", "Pong", "Poopy", "Porsche", "Potato", "Prickle", "Princess", "Pumpernickel",
        "Punk", "Purdy", "Purry", "Quagmire", "Quake", "Queen", "Queenie", "Queeny", "Queso", "Queso Ruby", "Quest", "Quickie", "Quimby",
        "Quinn", "Quino", "Quinzee", "Ramble", "Randy", "Rarity", "Rat", "Ray", "Reese", "Reeses Puff", "Ren", "Rio", "Riot", "River",
        ...
        "Tuffnut", "Tumble", "Turbo", "Twilight", "Twister", "Twix", "Ula", "Union", "Uriel", "Vanilla", "Vaxx", "Venture", "Via", "Vida",
        "Viktor", "Vinnie", "Vinyl", "Violet", "Vivienne", "Void", "Voltage", "Vox", "Wanda", "Webby", "Wendy", "Whiskers", "Whisper",
        "Wigglebottom", "Wigglebutt", "Windy", "Wishbone", "Wisp", "Wisteria", "Worm", "X'ek", "Zelda", "Zim", "Zoe"
    ]

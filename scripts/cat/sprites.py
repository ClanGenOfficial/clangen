...
class Sprites:
    ...
    def load_scars(self):
        ...
        medcatherbs_data = [
            ...
            ["BLUEBELLS", "LILY OF THE VALLEY", "HEART FLOWER", "HERBS", "PETALS", "NETTLE", "HEATHER", "GORSE", "JUNIPER", "RASPBERRY", "LAVENDER"],
        ...
        self.make_group('medcatherbs', (0, 4), 'acc_herbsDRY HERBS')

        # wild
        for row, wilds in enumerate(wild_data):
            for col, wild in enumerate(wilds):
                self.make_group('medcatherbs', (col, 3), f'acc_wild{wild}')

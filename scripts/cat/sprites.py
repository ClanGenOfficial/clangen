...
class Sprites():
    ...
    def load_scars(self):
        ...
        self.make_group(scars, (0, 1), 'scarsMANLEG')
        self.make_group(scars, (1, 1), 'scarsBRIGHTHEART')
        self.make_group(scars, (2, 1), 'scarsMANTAIL')
        self.make_group(scars, (3, 1), 'scarsNOLEFTEAR')
        self.make_group(scars, (4, 1), 'scarsNORIGHTEAR')
        self.make_group(scars, (5, 1), 'scarsNOEAR')
        self.make_group(scars, (0, 2), 'scarsBRIDGE')
        self.make_group(scars, (1, 2), 'scarsRIGHTBLIND')
        self.make_group(scars, (2, 2), 'scarsLEFTBLIND')
        self.make_group(scars, (3, 2), 'scarsBOTHBLIND')
        self.make_group(scars, (4, 2), 'scarsBURNPAWS')
        self.make_group(scars, (5, 2), 'scarsBURNTAIL')
        self.make_group(scars, (0, 3), 'scarsBURNBELLY')
        self.make_group(scars, (1, 3), 'scarsBEAKCHEEK')
        self.make_group(scars, (2, 3), 'scarsBEAKLOWER')
        self.make_group(scars, (3, 3), 'scarsBURNRUMP')
        self.make_group(scars, (4, 3), 'scarsCATBITE')
        self.make_group(scars, (5, 3), 'scarsRATBITE')
        ...
        self.make_group(f'{scars}extra', (0, 1), 'scarsextraMANLEG', sprites_y=2)
        self.make_group(f'{scars}extra', (1, 1), 'scarsextraBRIGHTHEART', sprites_y=2)
        self.make_group(f'{scars}extra', (2, 1), 'scarsextraMANTAIL', sprites_y=2)
        self.make_group(f'{scars}extra', (3, 1), 'scarsextraNOLEFTEAR', sprites_y=2)
        self.make_group(f'{scars}extra', (4, 1), 'scarsextraNORIGHTEAR', sprites_y=2)
        self.make_group(f'{scars}extra', (5, 1), 'scarsextraNOEAR', sprites_y=2)
        self.make_group(f'{scars}extra', (0, 2), 'scarsextraBRIDGE', sprites_y=2)
        self.make_group(f'{scars}extra', (1, 2), 'scarsextraRIGHTBLIND', sprites_y=2)
        self.make_group(f'{scars}extra', (2, 2), 'scarsextraLEFTBLIND', sprites_y=2)
        self.make_group(f'{scars}extra', (3, 2), 'scarsextraBOTHBLIND', sprites_y=2)
        self.make_group(f'{scars}extra', (4, 2), 'scarsextraBURNPAWS', sprites_y=2)
        self.make_group(f'{scars}extra', (5, 2), 'scarsextraBURNTAIL', sprites_y=2)
        self.make_group(f'{scars}extra', (0, 3), 'scarsextraBURNBELLY', sprites_y=2)
        self.make_group(f'{scars}extra', (1, 3), 'scarsextraBEAKCHEEK', sprites_y=2)
        self.make_group(f'{scars}extra', (2, 3), 'scarsextraBEAKLOWER', sprites_y=2)
        self.make_group(f'{scars}extra', (3, 3), 'scarsextraBURNRUMP', sprites_y=2)
        self.make_group(f'{scars}extra', (4, 3), 'scarsextraCATBITE', sprites_y=2)
        self.make_group(f'{scars}extra', (5, 3), 'scarsextraRATBITE', sprites_y=2)

...
def change_relationship_values(
    ...
    :param bool flip_log: If True, this will "flip" the cats used for to_cat and cat_from abbreviation replacements. This should really only be used for mutual relationship changes from events.
    """

...
ALL_FOREST_LEADER_EVENT_DEATH = FOREST_LEADER_EVENT_DEATH + \
                        FOREST_WARRIOR_EVENT_DEATH
ALL_PLAINS_LEADER_EVENT_DEATH = PLAINS_LEADER_EVENT_DEATH + \
                        PLAINS_WARRIOR_EVENT_DEATH
ALL_MOUNTAINOUS_LEADER_EVENT_DEATH = MOUNTAINOUS_LEADER_EVENT_DEATH + \
                        MOUNTAINOUS_WARRIOR_EVENT_DEATH
ALL_BEACH_LEADER_EVENT_DEATH = BEACH_LEADER_EVENT_DEATH + \
                        BEACH_WARRIOR_EVENT_DEATH

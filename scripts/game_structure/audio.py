...
from scripts.game_structure.game.settings import get_setting, set_setting
...
class MusicManager:
    def __init__(self):
        ...
        self.volume = get_setting("music_volume") / 100
        self.muted = False
    ...
    def change_volume(self, new_volume):
        ...
        set_setting("music_volume", new_volume)
        if pygame.mixer.music.get_busy():
            pygame.mixer.music.set_volume(self.volume)
...
class _SoundManager:
    def __init__(self):
        self.volume = get_setting("sound_volume") / 100
        self.pressed = None
    ...
    def change_volume(self, new_volume):
        ...
        # convert to a float and change volume accordingly
        self.volume = new_volume / 100
        set_setting("sound_volume", new_volume)

...
def json_load():
    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            new_cat.cat_sprites['kitten'] = cat["sprite_kitten"] if "sprite_kitten" in cat else ["spirit_kitten"]
            new_cat.cat_sprites['adolescent'] = cat["sprite_adolescent"] if "sprite_adolescent" in cat else["spirit_adolescent"]
            new_cat.cat_sprites['young adult'] = cat["sprite_young_adult"] if "sprite_young_adult" in cat else["spirit_young_adult"]
            new_cat.cat_sprites['adult'] = cat["sprite_adult"] if "sprite_adult" in cat else["spirit_adult"]
            new_cat.cat_sprites['senior adult'] = cat["sprite_senior_adult"] if "sprite_senior_adult" in cat else["spirit_senior_adult"]
            new_cat.cat_sprites['elder'] = cat["sprite_elder"] if "sprite_elder" in cat else["spirit_elder"]

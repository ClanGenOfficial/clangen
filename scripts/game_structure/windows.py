...
class ExileCat(UIWindow):
    """This window allows the user to specify the reason for exile"""
    def __init__(self, cat):
        super().__init__(scale(pygame.Rect((600, 400), (900, 400))),
                         window_display_title='Exile Cat',
                         object_id='#change_cat_gender_window',
                         resizable=False)
        self.history = History()
        game.switches['window_open'] = True
        ...
        self.heading = pygame_gui.elements.UITextBox(f"<b>-- How was this cat exiled? --</b>",
                                                     scale(pygame.Rect((20, 20), (860, 150))),
                                                     object_id="#text_box_30_horizcenter_spacing_95",
                                                     manager=MANAGER,
                                                     container=self)

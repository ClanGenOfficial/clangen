...
class ThoughtSchemaItem(BaseModel):
    ...
    biome: List[Biome] | MISSING = Field(
        MISSING,
    ...
    has_injuries: HasInjuries | MISSING = Field(
        MISSING,
    ...
    perm_conditions: PermConditions | MISSING = Field(
        MISSING,

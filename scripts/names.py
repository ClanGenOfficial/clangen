...
class Name(object):
    ...
    pelt_suffixes = {'TwoColour': ['patch', 'spot', 'splash', 'patch', 'spots'], 'Tabby': ['stripe', 'feather', 'leaf', 'stripe', 'shade'], 'Tabby2': ['stripe', 'feather', 'leaf', 'stripe', 'shade'],
                     'Speckled': ['dapple', 'speckle', 'spot', 'speck'], 'Speckled2': ['dapple', 'speckle', 'spot', 'speck'], 'Tortie': ['dapple', 'speckle', 'spot', 'dapple'], 'Tortie2': ['dapple', 'speckle', 'spot', 'dapple'], 'Rosette': ['dapple', 'speckle', 'spot', 'dapple'], 'Calico': ['stripe', 'dapple', 'patch', 'patch'], 'Smoke': ['fade', 'dusk', 'dawn']}

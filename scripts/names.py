...
class Name(object):
    ...
    normal_suffixes = [# common suffixes
        "fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur", "pelt", "pelt", "pelt", "pelt", "pelt", "pelt", "pelt", "pelt", "pelt", "tail", "tail", "tail",
        "tail", "tail", "tail", "tail", "tail", "claw", "claw", "claw", "claw", "claw", "claw", "claw", "foot", "foot", "foot", "foot", "foot", "whisker", "whisker", "whisker",
        "whisker", "heart", "heart", "heart", "heart", "heart",
    ...
    normal_prefixes = ["Adder", "Alder", "Ant", "Apple", "Ash", "Acorn", "Arch", "Aspen", "Bark", "Bay", "Bee", "Badger", "Beetle", "Beech", "Berry", "Bat", "Beaver", "Big",
                       "Birch", "Bird", "Bloom", "Borage", "Boulder", "Bounce", "Blossom", "Bracken", "Branch", "Brave", "Bramble", "Burdock", "Briar", "Bright", "Brindle",
                       "Bristle", "Broken", "Brook", "Bug", "Bumble", "Buzzard", "Cherry", "Chestnut", "Chive", "Cinder", "Cheetah", "Cinnamon", "Cloud", "Cold", "Crow", "Cedar",
                       "Claw", "Clover", "Copper", "Cone", "Creek", "Cricket", "Crooked", "Crouch", "Curl", "Curly", "Cypress", "Dapple", "Dove", "Dusk", "Dust", "Dawn", "Dead",
                       "Dew", "Doe", "Down", "Drift", "Duck", "Eagle", "Echo", "Eel", "Elm", "Ember", "Freckle", "Fringe", "Frozen", "Feather", "Fern", "Fennel", "Ferret", "Flame",
                       "Flower", "Fallen", "Fallow", "Fawn", "Fin", "Finch", "Flail", "Flutter", "Fir", "Frog", "Frond", "Flash", "Flax", "Fleet", "Flicker", "Flint", "Flip",
                       "Fly", "Fuzzy", "Goose", "Gorse", "Grass", "Gravel", "Gull", "Hail", "Hare", "Hay", "Hatch", "Half", "Hawk", "Heather", "Heavy", "Heron", "Hickory", "Hill",
                       "Hollow", "Horse", "Hoot", "Hop", "Hope", "Hound", "Holly", "Ivy", "Jagged", "Jay", "Jump", "Juniper", "Kestrel", "Kink", "Kite", "Lake", "Laurel", "Lark",
                       "Larch", "Lavender", "Leaf", "Lichen", "Leopard", "Lightning", "Lily", "Lizard", "Log", "Lost", "Low", "Lynx", "Little", "Long", "Loud", "Marsh", "Marigold",
                       "Maple", "Mole", "Moth", "Mouse", "Mallow", "Meadow", "Midge", "Milk", "Minnow", "Mint", "Mist", "Mistle", "Misty", "Murk", "Morning", "Moss", "Mossy",
                       "Mottle", "Mud", "Mumble", "Nectar", "Night", "Nettle", "Nut", "Needle", "Newt", "Oat", "Odd", "Oak", "One", "Otter", "Owl", "Parsley", "Patch", "Pear",
                       "Petal", "Pebble", "Perch", "Pigeon", "Python", "Pike", "Pine", "Pod", "Poppy", "Panther", "Pounce", "Prickle", "Quail", "Quick", "Quiet", "Rabbit",
                       "Ragged", "Reed", "Ripple", "Ridge", "River", "Rain", "Raven", "Rat", "Robin", "Rock", "Rose", "Rowan", "Rubble", "Running", "Rush", "Rook", "Root", "Rye",
    ...
    colour_prefixes = {'WHITE': ['White', 'White', 'Pale', 'Snow', 'Cloud', 'Milk', 'Hail', 'Frost', 'Ice', 'Sheep', 'Blizzard', 'Moon', 'Light'],
                       ...
                       'GREY': ['Grey', 'Grey', 'Ash', 'Cinder', 'Rock', 'Stone', 'Shade', 'Mouse', 'Smoke', 'Shadow', "Fog"],
    ...
    loner_names = ["Haku", "Pichi", "Poki", "Nagi", "Jubie", "Bonbon", "Beans", "Aurora", "Maleficent", "Luna",
                   ...
                   "Randy", "Ace", "Queeny", "Freddy", "Stella", "Rooster", "Sophie", "Maverick", "Seamus", 'Meowyman',
                   "Pickles", "Lacy", "Lucy", "Knox", "Lugnut", "Bailey", "Azula", "Lucky", "Sunny", "Sadie", "Sox",
                   "Bandit", "Onyx", "Quinn", "Grace", "Fang", "Ike", "Flower", "Whiskers", "Gust", "Peony", 'Human',
                   "Minnie", "Buddy", "Mollie", "Jaxon", "Dunnock", "Firefly", "Cheese", "Sandwich", "Spam", 'Brocolli',
                   "Prickle", "Insect", "Grasshopper", "Coral", "Windy", "Sofa", "McChicken", "Katy Purry", 'Mop',
                   "Fishtail", "Roman", "Wishbone", "Nova", "Quimby", "Quest", "Nessie", "Niles", "Neil", "Nutella",
                   "Nakeena", "Nuka", "Hughie", "Harvey", "Herc", "French", "Finch", "Frannie", "Flutie", 'Purdy',
                   ...
                   "Ninja", "Cinderblock", "Pip", "Pipsqueak", "Milque", "Toast", "Molly Murder Mittens", "Flabby", "Crunchy",
                   ...
                   "Cream", "Omlet", "Gizmo", "Feather", "Twix", "Silver,", "Ghost", "Wisp", "Obi Wan", 'Pikachu',
                   ...
                   "Catie", "Charm", "Crab", "Charles", "Caroline", "Conan", "Cloud", "Charlie", "Cowboy", 'Burger',

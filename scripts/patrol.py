...
class Patrol():
    ...
    def _filter_stat_cat(self, kitty):
    ...
    def get_stat_cats(self):
        ...
        for kitty in self.patrol_cats:
            ...
            if not self._filter_stat_cat(kitty):
                continue
            
            possible_stat_cats.append(kitty)

        print('PATROL LEADER', str(self.patrol_leader.name), 'RANDOM CAT', str(self.patrol_random_cat.name))

...
class ChooseAdoptiveParentScreen(Screens):
    ...
    def screen_switches(self):
        ...
        # Checkboxes and text
        self.mates_current_parents_text = pygame_gui.elements.UITextBox("Mates of current parents",
                                                                        scale(pygame.Rect((1030, 10), (219, -1))),
                                                                        object_id="#text_box_26_horizcenter",
                                                                        container=self.potential_container)

        self.unrelated_only_text = pygame_gui.elements.UITextBox("Not closely related",
    ...
    def get_valid_adoptive_parents(self):
        ...
        valid_parents = [inter_cat for inter_cat in Cat.all_cats_list if
                         not (
                                     inter_cat.dead or inter_cat.outside or inter_cat.exiled) and  # Adoptive parents cant be dead or outside
                         ...
                         (not self.mates_current_parents or self.is_parent_mate(self.the_cat,
                                                                                inter_cat)) and  # Toggle for only mates of current parents
                         (

...
class ChooseMateScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.with_selected_cat_text = pygame_gui.elements.UITextBox("Offspring with selected cat",
        ...
        self.have_kits_text = pygame_gui.elements.UITextBox("Can have biological kits",
    ...
    def update_offspring_container(self):
        ...
        and the page"""
        self.all_offspring = [Cat.fetch_cat(i) for i in list(self.the_cat.inheritance.kits) if

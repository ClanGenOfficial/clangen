...
class ListScreen(Screens):
    ...
    def get_cotc_cats(self):
        ...
        self.full_cat_list = []
        for the_cat in Cat.all_cats_list:
            if not the_cat.dead and the_cat.outside and the_cat.status != "driven off":
                self.full_cat_list.append(the_cat)
    ...
    def get_ur_cats(self):
        ...
        self.full_cat_list = []
        for the_cat in Cat.all_cats_list:
            if the_cat.ID in game.clan.unknown_cats and not the_cat.faded and the_cat.status != "driven off":
                self.full_cat_list.append(the_cat)

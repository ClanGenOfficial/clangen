    ...
    def screen_switches(self):
            ...
            if not get_version_info().is_source_build and not get_version_info().is_itch and get_version_info().upstream.lower() == "ClanGenOfficial/clangen".lower() and \
                ...
                if has_update(UpdateChannel(get_version_info().release_channel)):
                    ...
                    if os.path.exists(f"{get_cache_dir()}/suppress_update_popup"):
                        with open(f"{get_cache_dir()}/suppress_update_popup", 'r', encoding="utf-8") as read_file:
        ...
        if game.settings['show_changelog']:
            ...
            if os.path.exists(f"{get_cache_dir()}/changelog_popup_shown"):
                with open(f"{get_cache_dir()}/changelog_popup_shown", "r", encoding="utf-8") as read_file:
            ...
            if show_changelog:
                ...
                with open(f"{get_cache_dir()}/changelog_popup_shown", 'w', encoding="utf-8") as write_file:

...
class StartScreen(Screens):
    ...
    def screen_switches(self):
        ...
        try:
            ...
            if not get_version_info().is_source_build and get_version_info().upstream == "Thlumyn/clangen" and game.settings['check_for_updates'] and not has_checked_for_update:

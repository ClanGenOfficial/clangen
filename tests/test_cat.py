...
class TestMateFunctions(unittest.TestCase):
    ...
    def test_set_mate(self):
        ...
        # then
        self.assertEqual(cat1.current_mates[0], cat2.cat_id)
        self.assertEqual(cat2.current_mates[0], cat1.cat_id)
    ...
    def test_unset_mate(self):
        ...
        # then
        self.assertNotIn(cat2, cat1.current_mates)
        self.assertNotIn(cat1, cat2.current_mates)
        self.assertEqual(len(cat1.current_mates), 0)
        self.assertEqual(len(cat2.current_mates), 0)

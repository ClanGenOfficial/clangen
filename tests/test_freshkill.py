...
class FreshkillPileTest(unittest.TestCase):
    ...
    def test_feed_cats(self) -> None:
        ...
        test_warrior = Cat(status=StatusEnum.WARRIOR)
    ...
    def test_tactic_younger_first(self) -> None:
        ...
        youngest_warrior = Cat(status=StatusEnum.WARRIOR)
        youngest_warrior.moons = 20
        middle_warrior = Cat(status=StatusEnum.WARRIOR)
        middle_warrior.moons = 30
        oldest_warrior = Cat(status=StatusEnum.WARRIOR)
    ...
    def test_tactic_less_nutrition_first(self) -> None:
        ...
        lowest_warrior = Cat(status=StatusEnum.WARRIOR)
        lowest_warrior.moons = 20
        middle_warrior = Cat(status=StatusEnum.WARRIOR)
        middle_warrior.moons = 30
        highest_warrior = Cat(status=StatusEnum.WARRIOR)
    ...
    def test_pregnant_handling(self) -> None:
        # given
        # young enough kid
        pregnant_cat = Cat(status=StatusEnum.WARRIOR)
        pregnant_cat.injuries["pregnant"] = {
            "severity": "minor"
        }
        cat2 = Cat(status=StatusEnum.WARRIOR)
        cat3 = Cat(status=StatusEnum.WARRIOR)

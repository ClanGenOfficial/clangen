...
class FreshkillPileTest(unittest.TestCase):
    ...
    def test_add_freshkill(self) -> None:
        ...
        self.assertEqual(freshkill_pile.pile["expires_in_2"], self.amount + 1)
        self.assertEqual(freshkill_pile.pile["expires_in_1"], 0)
    ...
    def test_remove_freshkill(self) -> None:
        ...
        # then
        self.assertEqual(freshkill_pile1.pile["expires_in_2"], self.amount)
    ...
    def test_tactic_low_rank(self):
        ...
        self.freshkill_pile.pile["expires_in_2"] = current_amount
    ...
    def test_queen_handling(self) -> None:
        ...
        freshkill_pile.pile["expires_in_2"] = current_amount
